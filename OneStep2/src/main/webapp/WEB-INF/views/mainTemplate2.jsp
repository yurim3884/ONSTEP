...
<!--     <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.4.1/dist/css/bootstrap.min.css"> -->
    ...
    <link href="${pageContext.request.contextPath }/resources/assets/css/forms/form-widgets.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/plugins/dropify/dropify.min.css">
    <link href="${pageContext.request.contextPath }/resources/assets/css/pages/profile_edit.css" rel="stylesheet" type="text/css" />
...
<!--========================================================== sidebar ==============================================-->
<tiles:insertAttribute name="asidecom"/>
...
<!--         </div> -->
    ...
    <script src="${pageContext.request.contextPath }/resources/plugins/fullcalendar/custom-fullcalendar.advance2.js"></script>
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/profile_edit.js"></script>
      <script src="${pageContext.request.contextPath }/resources/plugins/maxlength/bootstrap-maxlength.min.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/forms/custom-maxlength.js"></script>
