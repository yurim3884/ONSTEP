        ...
        <nav id="sidebar">
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="${pageContext.request.contextPath }/resources/assets/img/onestep.png"
                            class="navbar-logo" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="/company/main" class="nav-link"> ONESTEP </a>
                </li>
            </ul>
                ...
                <li class="menu">
                    <a href="#" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            ...
                            <span onclick="location.href = '/company/insertForm' ">공고 등록</span>
                        </div>
                    </a>
                </li>
                <li class="menu">
                    <a href="#info" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            ...
                            <span onclick="location.href='/company/review'">기업 리뷰</span>
                        </div>
<!--                         <div> -->
...
<!--                         <li> -->
<!--                             <a href="/company/insertInfo"> 기업정보 등록 </a> -->
<!--                         </li> -->
<!--                         <li> -->
<!--                             <a href -->
<!--                             ="/company/review"> 기업리뷰 </a> -->
<!--                         </li> -->
<!--                     </ul> -->
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                        <li>
                            <a href="/company/myAnno"> 전체 채용 공고 </a>
                        </li>
                        <li>
                            <a href
                            ="/company/annoMem"> 공고 지원자 평가 </a>
                        </li>
                        <li>
                            <a href
                            ="/company/annoMem2"> 평가완료지원자 관리 </a>
                        </li>
                        <li>
                            <a href
                            ="/company/annoMem3"> 채용 현황 </a>
                        </li>
<!--                         <li> -->
<!--                             <a href="/company/cal"> 공고 캘린더 </a> -->
<!--                         </li> -->
                    </ul>
                    <li class="menu">
                    <a href="#" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <i class="las la-home"></i>
                            <span onclick="location.href = '/company/cal' "> 공고 캘린더</span>
                        </div>
                    </a>
                </li>
                ...
                <li class="menu-title"></li>
                 <li class="menu">
                 <a href="#pp" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <i class="lab la-medapps"></i>
                            <span>인재 관리</span>
                        </div>
                    ...
                    <ul class="collapse submenu list-unstyled" id="pp" data-parent="#accordionExample">
                        <li>
                            <a href="/company/mem"> 인재검색 </a>
                        </li>
                        <li>
                            <a href
                            ="/company/heart"> 관심인재 </a>
                        </li>
                        <li>
                            <a href="/company/proposalList"> 제안인재 </a>
                        </li>
                    </ul>
...
<!--                             <span onclick="location.href = '/company/mem' ">인재검색</span> -->
<!--                         </div> -->
<!--                     </a> -->
<!--                 </li> -->
<!--                     <li class="menu"> -->
...
<!--                             <div class=""> -->
<!--                                 <i class="lab la-medapps"></i> -->
<!--                                 <span onclick="location.href = '/company/heart' ">관심 인재관리</span> -->
<!--                             </div> -->
<!--                         </a> -->
<!--                     </li> -->
<!--                     <li class="menu"> -->
...
<!--                             <div class=""> -->
<!--                                 <i class="lab la-medapps"></i> -->
<!--                                 <span onclick="location.href = '/company/proposalList' ">제안 인재관리</span> -->
<!--                             </div> -->
<!--                         </a> -->
<!--                     </li> -->
                    ...
                    <li class="menu">
                        <a href="#pages" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                ...
                                <span onclick="location.href = '/company/payCard' ">프리미엄</span>
                            </div>
                        </a>
                    <li class="menu">
                        <a href="#pages" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <i class="las la-file"></i>
                                <span onclick="location.href = '/company/adList' ">광고 리스트 </span>
                            </div>
                        </a>
<!--                         <li class="menu-title"></li> -->
...
<!-- 			</a></li> -->
            ...
            <li class="menu">
              ...
              <ul class="collapse submenu list-unstyled" id="notice" data-parent="#accordionExample">
                        <li>
                            <a href="/company/notice"> 공지사항 </a>
                        </li>
                        <li>
                            <a href  ="/company/faq"> 문의하기 </a>
                        </li>
                        <li>
                            <a href="/company/inquirylist"> 나의 문의 내역 </a>
                        </li>
                    </ul>
                </ul>
