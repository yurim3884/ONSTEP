									...
									<table class="table">
										<thead>
											<tr>
												...
												<th><div class="th-content">확인여부</div></th>
											</tr>
										</thead>
										<tbody>
												...
												<c:otherwise>
													<c:forEach items="${alarmList }" var="alarm">
														<tr>
															...
															<td>
															<a href="${alarm.notificationUrl }">
															${alarm.postId } 님이 ${alarm.notificationContent }를 보냈습니다.
															</a>
															</td>
															<td>${alarm.postId }</td>
															<td><fmt:formatDate
												...
												<c:otherwise>
													<c:forEach items="${alarmList }" var="alarm">
														<tr>
															<td>${alarm.notificationId }</td>
															<td>
															${alarm.getId } 님이 ${alarm.notificationContent }를 받았습니다.
															</td>															
															<td>${alarm.getId }</td>
															<td><fmt:formatDate
																	value="${alarm.notificationDate }" /></td>
