...
$(function(){
	$('#card').on("click","#deleteBtn",function(event){
		...
		var comId = event.target.parentNode.parentNode.childNodes[1].childNodes[1].innerText;
		var memId = "${sessionScope.memberVO.memId}";
		var obj = {comId : comId, memId : memId }
		var jsonObj = JSON.stringify(obj);
		
		console.log("comId : " + comId , "memId : " + memId);

		
		$.ajax({
			url : "/myPage/ajaxsupDel",
			type : "post",
			data : jsonObj,
