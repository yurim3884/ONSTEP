...
<%--  <link href="${pageContext.request.contextPath }/resources/assets/css/darkmode/global.css" rel="stylesheet" type="text/css" /> --%>
<%--     <link href="${pageContext.request.contextPath }/resources/assets/css/darkmode/apps.css" rel="stylesheet" type="text/css" /> --%>
<!-- 차트css -->
...
<!--========================================================== sidebar ==============================================-->
<tiles:insertAttribute name="asideManager"/>
...
<script src="${pageContext.request.contextPath }/resources/plugins/editors/markdown/simplemde.min.js"></script>
<script src="${pageContext.request.contextPath }/resources/plugins/editors/markdown/custom-markdown.js"></script>
