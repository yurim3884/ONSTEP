...
// 문제 발생시 다시 수정할 수 있도록 한다.         
         ...
         if (startPage > 1) {
            ...
            (startPage - blockSize) +"'><span class='material-icons'><<</span><span class='sr-only'>prev</span></a></li>");
         }
         ...
         if (endPage < totalPage) {
            html.append("<li class='page-item'><a href='' class='page-link' data-page='"+
                  (endPage + 1) +"'><span class='material-icons'>>></span><span class='sr-only'>Next</span></a></li>");
         }
