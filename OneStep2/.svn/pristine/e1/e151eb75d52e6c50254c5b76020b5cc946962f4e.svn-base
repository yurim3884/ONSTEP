				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 p-0">
					<div class="login-one-start">
						...
						<div class="login-one-inputs mt-4 text-center font-12 strong">
							<a href="/member/forget" class="text-primary">아이디,비밀번호찾기</a>
						</div>
						<div class="login-one-inputs mt-4 text-center font-12 strong ">
							<p class="text font-12 mt-2 font-weight-300">계정이
								없으신가요?</p>
								
							<a href="/member/join" class="text-primary">일반회원 회원가입</a> 
							<a href="/member/companyjoin" style="margin-left: 20px" class="text-primary">기업회원
								회원가입</a>
						</div>
