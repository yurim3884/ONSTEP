													...
													<div>
														<div class="mb-0 row form-group" style="margin-top: 2% ">
															<label for="example-textarea"
																class="col-form-label col-md-2 col-form-label">시작 날짜</label>
															<div class="col-md-10">
														...
														<div class="mb-0 row form-group" style="margin-top: 2% ">
															<label for="example-textarea"
																class="col-form-label col-md-2 col-form-label">종료 날짜 </label>
															<div class="col-md-10">
																<input class="form-control" type="date"
														...
														<div class="mb-0 row form-group" style="margin-top: 2% ">
															<label for="example-textarea"
																class="col-form-label col-md-2 col-form-label" > 상품 detail </label>
															<div class="col-md-10">
																<textarea class="form-control" id="example-textarea"
																	rows="3" placeholder="Write some note.."
																	id="payContent" readonly="readonly"> value="상품 : ${prodId } +금액 ${payPay } "</textarea>
															</div>
														</div>
