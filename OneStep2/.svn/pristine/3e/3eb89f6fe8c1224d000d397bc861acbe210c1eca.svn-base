...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                <a href="#free" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <i class="las la-file"></i>
                          <span onclick="location.href='/free/freeList'" >프리랜서 </span>
                    </div>
                    </a>
              </li>
         <li class="menu-title"></li>
            <li class="menu">
                <a href="#proj" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <i class="las la-file"></i>
                          <span onclick="location.href='/free/projList'" >프로젝트 </span>
                    </div>
                    </a>
              </li>
                     <li class="menu-title"></li>
                ...
                <a href="#authentication" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        ...
                        <span onclick="location.href='/mypage/profile'">마이페이지</span>
                    </div>
                    <div>
                    </div>
                    </a>
            ...
            <li class="menu">
                <a href="#authentication" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        ...
                        <span onclick="location.href='/free/ht'">프리미엄</span>
                    </div>
                </a>
            </li>
            <li class="menu-title"></li>
            <li class="menu">
              ...
              <ul class="collapse submenu list-unstyled" id="notice" data-parent="#accordionExample">
                        <li>
                            <a href="/free/notice"> 공지사항 </a>
                        </li>
                        <li>
                            <a href  ="/free/faq"> 문의하기 </a>
                        </li>
                        <li>
                            <a href="/free/inquirylist"> 나의 문의 내역 </a>
                        </li>
                    </ul>
