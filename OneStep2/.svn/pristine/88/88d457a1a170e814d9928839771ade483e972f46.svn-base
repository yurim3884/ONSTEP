...
<%-- 							<li class="breadcrumb-item active" aria-current="page"><span>${companyVO.companyName}-기업정보</span></li> --%>
<!-- 						</ol> -->
<!-- 					</nav> -->
<!-- 				</div> -->
<!-- 			</li> -->
						...
						<div class="row w-100">
							<div class="col-xl-12 col-lg-12 align-self-center w-100">
								<a href="/member/main" class="btn btn-sm btn-primary p-1"><i
									class="las la-arrow-left"></i> 뒤로가기</a>
							</div>
							<div
								class="col-xl-8 col-lg-8 col-md-8 company-detail-container mt-5">
								<div class="d-flex align-items-start">
									<img src="/upload/${companyVO.companyLogo}"
										style="height: 300px; width: 300px;" alt="로고">
									<div class="company-info">
										<p class="name mb-1">${companyVO.companyName}/
											${companyVO.companyMain }</p>
										<p class="text-muted font-12 mb-1">
											<i class="las la-map-marker font-15"></i>${companyVO.companyAddr1}${companyVO.companyAddr2}</p>
										<a class="text-primary font-12 mb-2 d-block">${companyVO.companySmall}</a>
										<p>${companyVO.companyIntro }</p>
									</div>
								</div>
							</div>
							<div
								class="col-xl-4 col-lg-4 col-md-4 company-detail-container mt-5">
								<div class="company-info-right" style="">
									<p>
										대표자명 : <a>${companyVO.companyRepresentative}</a>
									</p>
									<p>
										임직원 수: <a>${companyVO.companyEmployees}</a>
									</p>
									<p>
										인사담당자 전화번호 : <a>${companyVO.companyPhone}</a>
									</p>
									<p>
										회사설립일자 : <a>${companyVO.companyEstablishment}</a>
									</p>
									<div
										class="d-flex social-media align-items-center justify-content-between">
						...
						<div class="w-100 animated-underline-content">
							<ul class="nav nav-tabs  mb-3" id="lineTab" role="tablist">
								<li class="nav-item"><a class="nav-link active"
									id="underline-about-tab" data-toggle="tab"
									href="#underline-about" role="tab"
									aria-controls="underline-about" aria-selected="true">기업정보</a></li>
								<li class="nav-item"><a class="nav-link"
									id="underline-project-tab" data-toggle="tab"
									href="#underline-project" role="tab"
									aria-controls="underline-project" aria-selected="false">채용중인공고</a>
								</li>
								<li class="nav-item"><a class="nav-link"
									id="underline-team-tab" data-toggle="tab"
									href="#underline-team" role="tab"
									aria-controls="underline-team" aria-selected="false">기업리뷰</a></li>
								<li class="nav-item"><a class="nav-link"
									id="underline-pay-tab" data-toggle="tab"
									href="#underline-pay" role="tab"
									aria-controls="underline-pay" aria-selected="false">연봉</a></li>
							</ul>
							<div class="tab-content" id="lineTabContent-3">
									...
									<div class="d-flex flex-wrap">
										<div class="col-xl-3 col-lg-4 col-md-4">
											<div class="contact-info mb-4">
												<p>
													<a href="#"><i class="las la-globe"></i>www.domainname.com</a>
												</p>
												<p>
													<a href="#"><i class="lar la-envelope"></i>info@mail.com</a>
												</p>
												<p>
													<a href="#"><i class="lar la-envelope"></i>contact@mail.com</a>
												</p>
												<p>
													<a href="#"><i class="las la-phone"></i>(+1) 458 5857
														578</a>
												</p>
												<p>
													<a href="#"><i class="las la-phone"></i>(+91) 689 4586
														102</a>
												</p>
											</div>
										...
										<div class="col-xl-6 col-lg-4 col-md-4">
											<div class="contact-info mb-4">
												...
												<div
													class="d-flex flex-wrap align-items-center skills-container">
													<span>.Net</span> <span>Java</span> <span>Node JS</span> <span>Javascript</span>
													<span>Angular JS</span> <span>PHP</span> <span>Laravel</span>
													<span>AWS Server</span> <span>Cake PHP</span> <span>Ionic</span>
													<span>React</span> <span>Vue</span> <span>Flutter</span>
												</div>
												<hr>
								...
								<!-- Projects -->
								<div class="tab-pane fade" id="underline-project"
									role="tabpanel" aria-labelledby="underline-project-tab">
									<div class="row w-100 m-0">
										<c:forEach items="${annoVO}" var="annoVO">
											<div class="col-xl-3 col-lg-4 col-md-4 mb-4">
												<div class="card single-project">
													<img src="/resources/upload/${companyVO.companyLogo}"
														class="card-img-top" alt="widget-card-2">
													<div class="card-body">
														<p class="meta-date">${annoVO.annoStartDate}</p>
														<h5 class="card-title">
															<a href="/member/detailAnno/${annoVO.annoId}">${annoVO.annoTitle}</a>
														</h5>
														<p class="card-text">${annoVO.annoTitle}</p>
								...
								<div class="tab-pane fade" id="underline-team" role="tabpanel"
									...
									<p class=" mb-1">혹시 현직자또는 퇴사자이신가요?</p>
									<button class="btn btn-sm btn-primary mb-2" id="reviewBtn">
										리뷰등록하기</button>
									<div class="row w-100 m-0">
														...
														<div class="card-body">
															<div class="user-profile">
																<img style="height: 200px; width: 200px;"
																	src="/resources/upload/${companyVO.companyLogo}"
																	class="" alt="...">
															</div>
															<div class="user-info">
																...
																<div class="card-star_rating">
																	<span class="badge badge-primary mb-1">${reviewVO.reviewStart }</span>
																	<br> <span class="badge badge-primary mb-1">기업
																		총점 : ${reviewVO.reviewScore }점</span> <br>
																</div>
																<!--  모달 Start -->
																...
																<div class="modal fade"
																	id="exampleModalCenter${reviewVO.reviewId}"
																		...
																		<div class="modal-content">
																			...
																			<div class="modal-body">
																				...
																				<div id="reviewVision">
																					...
																					<input type="text" class="kv-fa rating-loading"
																						value="${reviewVO.reviewVision / 2}"
																						data-size="xs" title="" disabled="disabled">
																				</div>
																				<div id="reviewWelfare">
																					<p class="modal-text">복지 :</p>
																					<input type="text" class="kv-fa rating-loading"
																						value="${reviewVO.reviewWelfare / 2}"
																						data-size="xs" title="" disabled="disabled">
																				</div>
																				<div id="reviewBalance">
																					<p class="modal-text">워라벨 :</p>
																					<input type="text" class="kv-fa rating-loading"
																						value="${reviewVO.reviewBalance / 2}"
																						data-size="xs" title="" disabled="disabled">
																				</div>
																				<div id="reviewCulture">
																					<p class="modal-text">기업내문화:</p>
																					<input type="text" class="kv-fa rating-loading"
																						value="${reviewVO.reviewCulture / 2}"
																						data-size="xs" title="" disabled="disabled">
																				</div>
																				<div id="reviewManage">
																					<p class="modal-text">경영진 :</p>
																					<input type="text" class="kv-fa rating-loading"
																						value="${reviewVO.reviewManage / 2}"
																						data-size="xs" title="" disabled="disabled">
																				</div>
																			</div>
								...
								<div class="tab-pane fade" id="underline-pay" role="tabpanel"
									aria-labelledby="underline-pay-tab">
									<div class="row w-100 m-0">
...
<script type="text/javascript">
	$(function() {
		...
		new Chart(document.getElementById("payChart"), {
		    type: 'horizontalBar',
		    data: {
		      labels: ["${companyVO.companyMain}분야 평균연봉","${companyVO.companyName}의 평균연봉"],
		      datasets: [{
		        label: "${companyVO.companyMain}분야 연봉비교",
		        backgroundColor: ["#3e95cd", "#8e5ea2"],
		        data: [parseInt(${avgPay}),${companyVO.companyPerson}] 
		      }]
		    },  
		    options: {
		      title: {
		        display: true,
		        text: '${companyVO.companyMain}분야 연봉비교'
		      }
		    }
		});
