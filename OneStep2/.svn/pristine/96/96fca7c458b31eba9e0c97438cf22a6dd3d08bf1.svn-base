...
<body>
    ...
    <div class="error-wrapper">
        <div class="col-md-6 error-left-section">
            ...
            <div class="error-left-content">
                <h1 class="mb-3 text-white">Oops!</h1>
                <p class="font-25 mb-5 text-white">Internal Server Error. Please try again after some time.</p>
                <a class="btn bg-gradient-primary text-white" href="/member/login">back</a>
            </div>
        </div>
        <div class="col-md-6 error-right-section">
            <img src="${pageContext.request.contextPath }/resources/assets/img/error-500-1.png" class="error-img" />
        </div>
    </div>
    <!-- Main Body Ends -->
    <!-- Footer Starts -->
    <div class="faq-footer">
        <div class="d-flex align-items-center justify-content-between">
            <p class="">Copyright © 2021 <a target="_blank" href="https://xato-web.web.app/">ONESTEP</a> | All rights reserved.</p>
