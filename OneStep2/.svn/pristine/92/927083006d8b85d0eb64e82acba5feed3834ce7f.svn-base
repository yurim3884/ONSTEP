				...
				<div id="controls" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						...
						<div class="carousel-item">
							<img class="d-block w-100"
								src="${pageContext.request.contextPath }/resources/assets/img/ddddddd.png"
								height="350px" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100"
								src="${pageContext.request.contextPath }/resources/assets/img/fffff.png"
...
<div
	class="col-xl-11 col-lg-12 col-md-12 col-sm-12 col-11 layout-spacing"
	style="margin: 0 auto;">
		...
		<div class="widget-content overflow-hidden">
			<div class="ticker-wrap"
				...
				<div class="ticker-heading" style="background-color: #4165a7">
					<p onclick="location.href='/member/notice'">공지사항</p>
				</div>
				<div class="ticker">
				...
				<div id="controls3" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						<c:forEach items="${advertList }" var="advertList">
							<c:if test="${advertList.advertId == 2 }">
								<div class="carousel-item active">
									<img class="d-block w-100"
										src="/upload/${advertList.advertAtt }" onerror="this.src='${pageContext.request.contextPath }/resources/assets/img/001.png'"
										width="728px" height="90px" style="border-radius: 5px;">
								</div>
							</c:if>
							<c:if test="${advertList.advertId == 3 }">
								<div class="carousel-item">
									<img class="d-block w-100"
										src="/upload/${advertList.advertAtt }" onerror="this.src='${pageContext.request.contextPath }/resources/assets/img/002.png'"
										width="728px" height="90px" style="border-radius: 5px;">
								</div>
							</c:if>
							<c:if test="${advertList.advertId == 4 }">
								<div class="carousel-item">
									<img class="d-block w-100"
										src="/upload/${advertList.advertAtt }" onerror="this.src='${pageContext.request.contextPath }/resources/assets/img/003.png'"
										width="728px" height="90px" style="border-radius: 5px;">
								</div>
							</c:if>
						</c:forEach>
					</div>
					<a class="carousel-control-prev" href="#controls3" role="button"
						data-slide="prev"> <span class="carousel-control-prev-icon"
						aria-hidden="true"></span> <span class="sr-only">이전</span>
					</a> <a class="carousel-control-next" href="#controls3" role="button"
						data-slide="next"> <span class="carousel-control-next-icon"
						aria-hidden="true"></span> <span class="sr-only">다음</span>
					</a>
				</div>
...
<div class="col-lg-11 col-md-6 layout-spacing" style="margin: 0 auto;">
	<div class="widget-content widget-content-area">
		<div class="widget-header">
			<div class="row">
				<div class="col-xl-12 col-md-12 col-sm-12 col-12" align="center">
					<h4>취업뉴스</h4>
					<br>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div id="controls1" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner col-11" style="margin: 0 auto;">
						<div class="carousel-item active">
							<table style="width: 100%">
								<tr>
									<c:forEach var="newsList" items="${newsList}" end="1">
										<td><img alt="" src="${newsList.img}"></td>
										<td><a href="${newsList.url}"> <h6>${newsList.title}</h6></a></td>
									</c:forEach>
								</tr>
							</table>
						</div>
						<div class="carousel-item">
							<table style="width: 100%">
								<tr>
									<c:forEach var="newsList" items="${newsList}" begin="2" end="3">
										<td><img alt="" src="${newsList.img}"></td>
										<td><a href="${newsList.url}"><h6>${newsList.title}</h6></a></td>
									</c:forEach>
								</tr>
					...
					<a class="carousel-control-prev" href="#controls1" role="button"
						data-slide="prev"> <span class="carousel-control-prev-icon"
						aria-hidden="true"></span> <span class="sr-only">이전</span>
					</a> <a class="carousel-control-next" href="#controls1" role="button"
						data-slide="next"> <span class="carousel-control-next-icon"
						aria-hidden="true"></span> <span class="sr-only">다음</span>
					</a>
				</div>
...
<div class="col-xl-12 col-lg-12 col-md-12 "
	...
	<select class="form-control col-lg-2 mt-3" id="select"
		style="margin-left: 40px;">
		<option value="new">최신순</option>
		<option value="score">평점순</option>
	</select> <br>
	<div class="searchable-items grid card-box "
		style="margin: 0 auto; border: white;">
									...
									.ajax({
										...
										success : function(res) {
											...
											for (var i = 0; i < res.annoList.length; i++) {
												...
												html += "    <div class='card single-seller' style='border-radius: 3%; z-index: 33; box-shadow: 0 4px 4px -4px #4165a7; box-shadow: 4px 4px 4px -4px #4165a7; border: 4px solid; height: 425px;'  >";
