									...
									<tbody>
										<c:forEach items="${member }" var="member">
											<tr>
												...
												<td>${member.eduList[0].eduMajor1 }</td>
												<td>${member.careerList[0].careerCmpName }</td>
												<td><c:if
														test="${empty member.applyList[0].applyResult}">
														<button data-target="#scrollableModal${member.memId}"
															data-toggle="modal">점수 입력하기</button>
													</c:if> ${member.applyList[0].applyResult}</td>
											</tr>
														...
														<div class="modal-body">
																				...
																				<div
																					...
																					<ul class="nav nav-tabs  mb-3" id="lineTab"
																						...
																						<li class="nav-item"><a
																							...
																							id="underline-specification-tab"
																							data-toggle="tab" href="#underline-specification"
																							role="tab"
																					...
																					<div class="tab-content" id="lineTabContent-3">
																						<div class="tab-pane fade show active"
																							...
																							<div class="d-flex flex-wrap p-2">
																								...
																								<p class="text-muted">
																									<i class="lar la-check-circle"></i> 산업디자인 >
																									금속디자인, 문구디자인
																								</p>
																								<p class="text-muted">
																									<i class="lar la-check-circle"></i>
	                                               		 ...
	                                               		 ${member.careerList[0].careerJoinDate}" ~ 재직 중
																					...
																					<div class="tab-content" id="lineTabContent-3">
																						<div class="tab-pane fade show active"
																							...
																							<div class="d-flex flex-wrap p-2">
																								<p class="text-muted mb-4">
																									<c:if
																										test="${member.langList[0].langName == 1 }">영  어</c:if>
																									<c:if
																										test="${member.langList[0].langName == 2 }">일본어</c:if>
																									<c:if
																										test="${member.langList[0].langName == 3 }">중국어</c:if>
																								</p>
																								<div class="row mb-3 w-100">
																									<div class="col-md-4">
																						...
																						<div class="tab-pane fade show active"
																							...
																							<div class="d-flex flex-wrap p-2">
																								<p class="text-muted mb-4">
																									중국어
																									<c:if
																										test="${member.langList[1].langName == 1 }">영어</c:if>
																									<c:if
																										test="${member.langList[1].langName == 2 }">일본어</c:if>
																									<c:if
																										test="${member.langList[1].langName == 3 }">중국어</c:if>
																								</p>
																								<div class="row mb-3 w-100">
																									<div class="col-md-4">
																										...
																										<div>
																											...
																											<p class="text-muted">
																												<i class="lar la-check-circle"></i>
																												${member.langList[3].langTestDate }
																												2023-04-17
																											</p>
																											<p class="text-muted">
																												<i class="lar la-check-circle"></i>
																												${member.langList[3].langTestScore }6급 /
																												260점
																											</p>
																										</div>
																									</div>
																							...
																							<div class="d-flex flex-wrap p-2">
																								...
																								<div class="row mb-3 w-100">
																									<div class="col-md-8">
																										...
																										<div>
																											<p class="text-muted">
																												<i class="lar la-check-circle"></i> 포트폴리오
																												URL │ <a
																									...
																									<div class="col-md-8">
																										...
																										<div>
																											...
																											<c:if
																												...
																												<p class="text-muted">
																													<i class="lar la-check-circle"></i> 고용지원금
																													대상</a>
																												</p>
																											</c:if>
																											<c:if
																...
																<form action="/company/updateApply" method="post">
																	...
																	<input type="hidden"
																		value="${member.annoList[0].annoId }"> <input
																		type="hidden" value="${member.applyList[0].applyId }"
																		name="applyId"> <br> 점수 : <input
																		type="number" class="form-control" max="10" min="1"
																		name="applyTotal" placeholder="1에서 10까지 입력해주세요" /> <br>

																	결과 : <select class="form-control" name="applyResult">
																		<option>합격</option>
																		<option>불합격</option>
																	</select> <br> 피드백 : <input type="text"
																		class="form-control centered-right" maxlength="25"
																		name="applyResultComment"> <br>
																	<button class="btn btn-block btn-lg btn-primary "
																		type="submit">점수 및 피드백하기</button>
																</form>
