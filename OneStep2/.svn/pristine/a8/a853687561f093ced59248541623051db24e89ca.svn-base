												...
												<div class="row">
													<div class="col-md-12 mx-0">
														<form id="msform" action="/company/insert" method="post"
																...
																<div class="form-card">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoTitle" value="${anno.annoTitle }" readonly="readonly">
																		</div>
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">공고
																			내용</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoContent" value="${anno.annoContent }" readonly="readonly">
																		</div>
																	</div>
																	<div class="form-group row">
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoType" value="${anno.annoType }" readonly="readonly">
																		</div>
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<select class="form-control form-control-sm"
																				...
																				<option <c:if test="${anno.annoStaly eq '인턴' }">selected="selected" </c:if>>인턴</option>
																				<option <c:if test="${anno.annoStaly eq '인턴' }">selected="selected" </c:if>>정규직</option>
																				<option <c:if test="${anno.annoStaly eq '인턴' }">selected="selected" </c:if>>임원</option>
																			</select>
																		</div>
																	</div>
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoMb" value="${anno.annoMb }" readonly="readonly">
																		</div>
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">모집인원</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control" type="number" value="${anno.annoMem }"
																	...
																	<div class="form-group row">
																		<label
																			...
																			(개월)</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control" type="number" value="${anno.annoProbation }"
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control" type="number"
																				value="${anno.annoSalary }" id="example-number-input"
																	...
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
                                                        					...
                                                        					<input  class="form-control" type="text" name="keyword"  value="${keyword.annoKwname } " readonly="readonly">
                                                    					    </c:forEach>
																		</div>
																	</div>
																	<div class="form-group row">
																				...
																				<div class="form-group row">
																					<div class="col-lg-12 col-md-12 col-sm-12">
																						...
																						<label for="file-upload"
																							...
																							type="file" accept="image/*" value="${anno.attId }"
																							style="display: none;">
																					</div>
																				</div>
																			</div>
															...
															<fieldset>
																<div class="form-card">
																	...
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoManager" value="${anno.annoManager }" required>
																		</div>
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">담당자
																			전화번호</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<div class="input-group input-group-solid">
																				...
																				<input type="text"
																					...
																					placeholder="Phone" value="${anno.annoTel }" name="annoTel"
																					required>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<div class="input-group input-group-solid">
																				...
																				<input type="text"
																					class="form-control form-control-solid"
																					placeholder="Email" value="${anno.annoEmail }" name="annoEmail"
																					required>
																			</div>
																		</div>
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoWork" value="${anno.annoWork }" readonly="readonly">
																		</div>
																	</div>
																	<div class="form-group row">
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoDm1"  value="${anno.annoDm1 }" readonly="readonly">
																			<input class="form-control form-control-solid"
																				type="text" name="annoDm2"  value="${anno.annoDm2 }" readonly="readonly">
																		</div>
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">근무부서</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoGb" value="${anno.annoGb }" readonly="readonly">
																		</div>
																	</div>
																	<div class="form-group row">
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<select class="form-control form-control-sm"
																				...
																				<option <c:if test="${anno.annoDay eq '주 6일' }">selected="selected" </c:if>>주 6일</option>
																				<option <c:if test="${anno.annoDay eq '주 5일' }">selected="selected" </c:if>>주 5일</option>
																			</select>
																		</div>
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">근무
																			시간</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control" type="number" value="${anno.annoTime }"
																	...
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="industryCode" value="${anno.industryCode }" readonly="readonly">
																		</div>
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">지역</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoWd" value="${anno.annoWd }" readonly="readonly">
																		</div>
																	</div>
																...
																<div class="form-card">
																	...
																	<div class="form-group row">
																		<label
																			...
																			제한</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control" type="number" value="${anno.annoAge }"
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<select class="form-control form-control-sm"
																				...
																				<option <c:if test="${anno.annoGender eq '남성' }">selected="selected" </c:if>>남성</option>
																				<option <c:if test="${anno.annoGender eq '여성' }">selected="selected" </c:if>>여성</option>
																				<option <c:if test="${anno.annoGender eq '상관없음' }">selected="selected" </c:if>>상관없음</option>
																			</select>
																		</div>
																	</div>
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<select class="form-control form-control-sm"
																				...
																				<option <c:if test="${anno.annoStu eq '석/박사' }">selected="selected" </c:if>>석/박사</option>
																				<option <c:if test="${anno.annoStu eq '대학교 (4년제)' }">selected="selected" </c:if>>대학교 (4년제)</option>
																				<option <c:if test="${anno.annoStu eq '대학 (2~3년제)' }">selected="selected" </c:if>>대학 (2~3년제)</option>
																				<option <c:if test="${anno.annoStu eq '고등학교' }">selected="selected" </c:if>>고등학교</option>
																			</select>
																		</div>
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<select class="form-control form-control-sm"
																				...
																				<option <c:if test="${anno.annoCareer eq '신입' }">selected="selected" </c:if>>신입</option>
																				<option <c:if test="${anno.annoCareer eq '경력' }">selected="selected" </c:if>>경력</option>
																				<option <c:if test="${anno.annoCareer eq '신입 경력' }">selected="selected" </c:if>>신입 경력</option>
																			</select>
																		</div>
																	</div>
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoJo" value="${anno.annoJo }" readonly="readonly">
																		</div>
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoUd" value="${anno.annoUd }" required>
																		</div>
																	</div>
																	<div class="form-group row">
																		<label
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input class="form-control form-control-solid"
																				type="text" name="annoIntro" value="${anno.annoIntro }" required>
																		</div>
																	</div>
															...
															<fieldset>
																<div class="form-card">
																	<h5 class="fs-title mb-4 text-center">실패 빈칸없이 다시 입력해주세요!</h5>
																	<br>
