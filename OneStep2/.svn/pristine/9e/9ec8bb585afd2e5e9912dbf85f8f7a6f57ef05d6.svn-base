...
<div class="col-10  layout-spacing">
	...
	<div class="col-10" style="margin: 0 auto; text-align: right">
		<fmt:formatDate value="${board.boardStart}" var="boardStart"
			pattern="yyyy-MM-dd" />
	...
	<div class="col-10" style="margin-left: 150px; ">
		<span> <br> <br> <br> <c:out
				value="${board.boardContent }" /> <br> <br> <br> <br>
			<br>
		</span>
	</div>
	<hr class="col-10" style="margin: 0 auto;">
	...
	<c:choose>
		...
		<c:otherwise>
			<div class="col-10"
				style="background-color: #f7f7f7; margin: 0 auto;">
				<br> <span class="btn btn-primary container-disable"> 답변
				</span> <span
					style="color: black; font-size: 18pt; vertical-align: middle;">${answer.answerTitle }
					.</span> <br> <br>
			</div>
			<hr class="col-10" style="margin: 0 auto;">
			<div class="col-10" style="margin: 0 auto; text-align: right" >
				<fmt:formatDate value="${answer.answerStart}" var="boardStart"
					pattern="yyyy-MM-dd" />
				<c:out value="${boardStart }" />
			</div>
			<hr class="col-10" style="margin: 0 auto;">
			<div class="col-10" style="margin: 0 auto;">
				<span> <br> <br> <br> ${answer.answerContent }
					<br> <br> <br>
				</span>
			</div>
		</c:otherwise>
