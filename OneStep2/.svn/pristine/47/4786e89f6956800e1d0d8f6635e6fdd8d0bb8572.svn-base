                    ...
                    <div class="col-xl-3 col-lg-4 col-md-4 mb-4">
                        <div class="profile-left">
                            <div class="image-area">
                                <img class="user-image" src='${pageContext.request.contextPath }/resources/images/profile/2023/05/06/952eb1b2-b99a-41fc-8174-1afff3461a1a_1.png' >
...
<%-- 							</c:choose> --%>
							...
							<img height="100px;"
								src="/resources/upload/${annoSupList.companyVO.companyLogo}"
