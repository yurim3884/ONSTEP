...
<%--         <script src="${pageContext.request.contextPath }/resources/assets/js/star.js"></script> --%>
...
<!--     <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.4.1/dist/css/bootstrap.min.css"> -->
    ...
    <link href="${pageContext.request.contextPath }/resources/plugins/select2/select2.min.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath }/resources/assets/css/forms/form-widgets.css" rel="stylesheet" type="text/css">
    ...
    <link href="${pageContext.request.contextPath }/resources/plugins/tagify/tagify.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath }/resources/assets/css/forms/custom-tagify.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath }/resources/assets/css/forms/form-widgets.css" rel="stylesheet" type="text/css">
    ...
    <link href="${pageContext.request.contextPath }/resources/assets/css/pages/error/error_2.css" rel="stylesheet" type="text/css" />  
    <link href="${pageContext.request.contextPath }/resources/assets/css/pages/pricing.css" rel="stylesheet" type="text/css" />
   <link href="${pageContext.request.contextPath }/resources/assets/css/forms/multiple-step.css" rel="stylesheet" type="text/css">
      <link href="${pageContext.request.contextPath }/resources/assets/css/pages/faq/faq.css" rel="stylesheet" type="text/css" /> 
   <link href="${pageContext.request.contextPath }/resources/assets/css/dashboard/dashboard_3.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath }/resources/assets/css/dashboard/dashboard_4.css" rel="stylesheet" type="text/css" />
    <link href="${pageContext.request.contextPath }/resources/assets/css/dashboard/dashboard_5.css" rel="stylesheet" type="text/css" />
...
font-family: 'Noto Sans KR', sans-serif;
	...
	.rate inputins/apex/apexcharts.css":checked ~ .rate label:hover ~ label,  
...
<!--========================================================== sidebar ==============================================-->
<tiles:insertAttribute name="asideFree"/>
...
<!--         </div> -->
    ...
    <script src="${pageContext.request.contextPath }/resources/assets/js/forms/forms-validation.js"></script>
    ...
    <script src="${pageContext.request.contextPath }/resources/plugins/tagify/tagify.min.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/forms/custom-select2.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/forms/file-upload.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/forms/custom-tagify.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/apps/ecommerce.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/dashboard/dashboard_2.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/forms/multiple-step.js"></script>
    <script src="${pageContext.request.contextPath }/resources/assets/js/pages/faq/faq.js"></script>
